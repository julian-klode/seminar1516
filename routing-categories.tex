...
IERP, which most likely refers to the The Interzone Routing Protocol for Ad Hoc Networks, an Internet Draft;
and SrcRR, a wireless mesh network routing protocol. It is unclear what exactly
...
which is used in the Freifunk community, for example.
