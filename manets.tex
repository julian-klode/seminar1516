...
For example, in figure~\ref{ommex}, we can see that the min-power path $S \to B \to D$
has a cost of 18. It's minimum residual energy will be $2$, as node $B$ needs
